    ...
    public class TMPTextSelectorA : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        private void LateUpdate()
        {
            ...
            if (_mIsHoveringObject)
            {
                ...
                var charIndex = TMP_TextUtilities.FindIntersectingCharacter(_mTextMeshPro, Input.mousePosition, Camera.main, true);
                ...
                if (wordIndex != -1 && wordIndex != _mLastWordIndex)
                {
                    ...
                    var wordPos = _mTextMeshPro.transform.TransformPoint(_mTextMeshPro.textInfo.characterInfo[wInfo.firstCharacterIndex].bottomLeft);
                    ...
                    {
                        var vertexIndex = _mTextMeshPro.textInfo.characterInfo[wInfo.firstCharacterIndex + i].vertexIndex;
